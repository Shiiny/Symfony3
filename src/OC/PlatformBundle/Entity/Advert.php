...
{
    /**
     * @ORM\OneToOne(targetEntity="OC\PlatformBundle\Entity\ImageEntity", cascade={"persist", "remove"})
     */
    private $image;
    ...
    */
     ...
     * Set image
     *
     * @param \OC\PlatformBundle\Entity\ImageEntity $image
     *
     * @return Advert
     */
     ...
     * Get image
     *
     * @return \OC\PlatformBundle\Entity\ImageEntity
     */
